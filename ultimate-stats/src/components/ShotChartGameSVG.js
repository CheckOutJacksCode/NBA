...
function ShotChartGameSVG({ shotsData, playerid, boxData, season }) {

    let [state, setState] = useState(true);
    let [myPlot, setMyPlot] = useState("myPlot2");
    let [chartTitle, setCharTitle] = useState("GAME SHOT CHART");
...
export default ShotChartGameSVG;